---
layout: post
title: Commands in UWP Diagram | Syncfusion®
description: Learn about commands in the Syncfusion® UWP Diagram control, including alignment, spacing, sizing, clipboard, zoom, and undo or redo operations.
