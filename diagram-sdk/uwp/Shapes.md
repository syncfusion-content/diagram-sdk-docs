---
layout: post
title: Shapes in UWP Diagram | Syncfusion®
description: Learn about shapes in the Syncfusion® UWP Diagram control, including built-in basic, flowchart, and arrow shapes for diagram creation.
