...
To create a bezier segment, the [`segment.type`](https://ej2.syncfusion.com/documentation/api/diagram/segments) is set as `bezier` and need to specify [`type`](https://ej2.syncfusion.com/documentation/api/diagram/segments) for the connector. The following code example illustrates how to create a default bezier segment.
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/typescript/connectors-cs14" %}
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/typescript/connectors-cs15" %}
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/typescript/connectors-cs16" %}
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/typescript/connectors-allowSegReset" %}

### How to customize Bezier Segment Thumb Size

Bezier segment thumbs default to size 10. This can be adjusted globally or for individual connectors using the [`segmentThumbSize`](https://ej2.syncfusion.com/documentation/api/diagram#segmentthumbsize) property.
To change the thumb size for all Bezier connectors, set the [`segmentThumbSize`](https://ej2.syncfusion.com/documentation/api/diagram#segmentthumbsize) property in the diagram’s model.
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/typescript/connectors-cs63" %}