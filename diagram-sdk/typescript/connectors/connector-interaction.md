---
layout: post
title: Connector Interaction in TypeScript Diagram | Syncfusion®
...
The TypeScript Diagram provides support to flip the connector. The [`flip`](https://ej2.syncfusion.com/documentation/api/diagram/flipdirection) is performed to give the mirrored image of the original element.
