...
Diagram allows to add images as [`image`](https://ej2.syncfusion.com/documentation/api/diagram/imagemodel) nodes. The shape property of node allows you to set the type of node and for image nodes, it should be set as **image**. In addition, the source property of shape enables you to set the image source.
...
The scale property of the node allows to stretch the image as you desired (either to maintain proportion or to stretch). By default, the [`scale`](https://ej2.syncfusion.com/documentation/api/diagram/image#scale) property of the node is set as **meet**. The [`align`](https://ej2.syncfusion.com/documentation/api/diagram/image#align) property is used to set the alignment of the image.
...
Html elements can be embedded in the diagram through [`Html`](https://ej2.syncfusion.com/documentation/api/diagram/htmlmodel) type node. The shape property of node allows you to set the type of node and to create a HTML node it should be set as `HTML`.
...
The scale property of the node allows to stretch the svg content as you desired (either to maintain proportion or to stretch). By default, the [`scale`](https://ej2.syncfusion.com/documentation/api/diagram/nativeModel#scale) property of native shape is set as **meet**.
...
* The [`Basic`](https://ej2.syncfusion.com/documentation/api/diagram/basicshapemodel) shapes are common shapes that are used to represent the geometrical information visually. To create basic shapes, the type of the shape should be set as **basic**. Its shape property can be set with any one of the built-in shape.

* To render a rounded rectangle, you need to set the type as basic and shape as rectangle. Set the [`cornerRadius`](https://ej2.syncfusion.com/documentation/api/diagram/basicShapeModel#cornerradius) property to specify the radius of rounded rectangle.
