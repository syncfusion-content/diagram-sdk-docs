...
# How to Connect MySQL in TypeScript Diagram
...
| Node.js | v20.x or later | JavaScript runtime for TypeScript |
| npm | Latest | Package manager for TypeScript dependencies |
...
This section explains how to create an ASP.NET Core Web API project that connects to MySQL and exposes data for use by the Syncfusion® TypeScript Diagram component.
...
- `AddCors()`: Configures CORS to allow TypeScript frontend (different origin) to make requests.
...
## Integrating Syncfusion® TypeScript Diagram

The following steps describe how to render the Diagram and connect it to the MySQL Server back-end.

### Step 1: Creating the TypeScript client application

Create the TypeScript client application using the following commands in a Visual Studio Code terminal or command prompt:

```bash
npm create vite@latest diagram_mysql.client -- --template vanilla-ts
```
```bash
cd diagram_mysql.client
```

This command scaffolds a new TypeScript application using Vite.
...
For this project, the "Bootstrap 5.3" theme is applied. Other themes can be selected, or the existing theme can be customized to meet specific project requirements. For detailed guidance on theming and customization, refer to the [Syncfusion® TypeScript Components Appearance](https://ej2.syncfusion.com/documentation/appearance/theme-studio) documentation.

### Step 3: Add Syncfusion® TypeScript Diagram
...
Create a basic Diagram instance in **src/main.ts**:
...
Here is the complete **src/main.ts** file:
...
### Starting the TypeScript frontend
...
3. Check frontend configuration
   ...
   - Confirm the DataManager/service URL in **src/main.ts** uses the correct HTTP port, e.g.: **http://localhost:5296/api/diagram/items**

### Application shows the diagram twice
  - Stop the TypeScript client application (press **Ctrl+C** in the terminal where it's running) and then restart it:
    ```bash
    npm run dev
    ```
...
A fully functional working sample of this project is available on [GitHub Repository](https://github.com/SyncfusionExamples/ej2-web-diagram-examples/tree/master/TypeScript/connecting-to-database/syncfusion-ts-diagram-MySQL)
...
- [Syncfusion® TypeScript Diagram Getting Started](https://ej2.syncfusion.com/documentation/diagram/getting-started)
- [Data Binding Documentation](https://ej2.syncfusion.com/documentation/diagram/data-binding)
- [Organizational Chart Layout](https://ej2.syncfusion.com/documentation/diagram/automatic-layout/org-chart)
