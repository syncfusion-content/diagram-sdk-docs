---
layout: post
title: Interaction of nodes in TypeScript Diagram control | Syncfusion®
...
# Node Interaction in TypeScript Diagram control
...
A node can be selected at runtime by using the [`select`](https://ej2.syncfusion.com/documentation/api/diagram#select) method and the selection can be cleared in the diagram by using the [`clearSelection`](https://ej2.syncfusion.com/documentation/api/diagram#clearselection) or [`unSelect`](https://ej2.syncfusion.com/documentation/api/diagram#unselect) method. The following code explains how to select and clear selection in the diagram.
...
|----|----|----|
|[`unSelect`](https://ej2.syncfusion.com/documentation/api/diagram#unselect)| NodeModel/ConnectorModel | The object to remove from the selection.|
|[`clearSelection`](https://ej2.syncfusion.com/documentation/api/diagram#clearselection)| - | Clears all the selection in the diagram.|
...
A node can be dragged at runtime by using the [`drag`](https://ej2.syncfusion.com/documentation/api/diagram#drag) method. The following code explains how to drag the node by using the drag method.
...
A node can be resized at runtime by using the [`scale`](https://ej2.syncfusion.com/documentation/api/diagram#scale) method. The following code explains how to resize the node by using the scale method.
...
A node can be rotated at runtime by using the [`rotate`](https://ej2.syncfusion.com/documentation/api/diagram#rotate) method. The following code explains how to rotate the node by using the rotate method.
...
| -------- | ----------- |
|HorizontalFlip |[`Horizontal`](https://ej2.syncfusion.com/documentation/api/diagram/flipDirection) is used to flip the node to be mirrored across the horizontal axis.|
|VerticalFlip|[`Vertical`](https://ej2.syncfusion.com/documentation/api/diagram/flipDirection) is used to flip the node to be mirrored across the vertical axis.|
|Both|[`Both`](https://ej2.syncfusion.com/documentation/api/diagram/flipDirection) is used to flip the node to be mirrored across the horizontal and vertical axes.|
...
The [`flipMode`](https://ej2.syncfusion.com/documentation/api/diagram/flipMode) is used to control the behavior of the flip object whether to flip the object along with the port and label.
