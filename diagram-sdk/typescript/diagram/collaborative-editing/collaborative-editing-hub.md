---
layout: post
title: SignalR Hub Services in TypeScript Diagram | Syncfusion®
description: Implement ASP.NET Core SignalR hub services with Redis in the Syncfusion® TypeScript Diagram for real-time collaborative editing.
...
# SignalR Hub Services in TypeScript Diagram

## Overview

This guide explains how to configure ASP.NET Core SignalR with Redis for real-time collaborative editing in a TypeScript application. It covers creating the app, installing packages, configuring SignalR, implementing the hub, handling conflicts, and managing Redis cleanup.
...
Refer to the `RedisService` file in the `Services` folder of the [TypeScript Diagram Collaborative Editing GitHub sample](https://github.com/SyncfusionExamples/ej2-web-diagram-examples/tree/master/CollaborativeEditing), and add the `RedisService` to the `Program.cs` file.
