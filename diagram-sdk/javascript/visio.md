---
layout: post
title: Import and Export Visio files in JavaScript Diagram | Syncfusion®
description: Import and export Microsoft Visio (.vsdx) files in the Syncfusion® JavaScript Diagram to reuse, edit, and share Visio diagrams on the web.
...
# Import and Export Visio files in JavaScript Diagram
...
- Export diagrams created or modified in JavaScript Diagram control for use in Microsoft Visio.  
...
The [`diagramImporting`](../api/diagram/iimportingeventargs) event is triggered during the Visio import process. This event provides information about the current import status, available pages, warnings or errors, and supports page selection or cancellation of the import operation.
...
## Export JavaScript Diagram to Visio
...
The following example exports an JavaScript Diagram to a Microsoft Visio (**.vsdx**) file using the `exportToVisio` method.
...
The [`diagramExporting`](../api/diagram/iexportingeventargs) event provides status updates, reports warnings or errors, and supports cancellation of the export operation.
