...
# Collaborative Editing in JavaScript Diagram

Collaborative editing enables multiple users to edit diagrams simultaneously in real-time, providing a seamless collaborative experience in JavaScript applications.

## Purpose

Collaborative editing in JavaScript Diagram control allows multiple users to edit and review diagrams in real time, ensuring accuracy, consistency, and faster updates. It streamlines teamwork by reducing delays, improving communication through comments, and maintaining data integrity with version tracking.

## Configuration

* Use **SignalR** for real-time communication between the JavaScript app and server.
...
* Basic setup:
    ...
    * Connect the JavaScript app to the hub. [Refer link](./ej2-collaborative-editing).
...
A complete working example is available in the [JavaScript Diagram Collaborative Editing GitHub repository](https://github.com/SyncfusionExamples/ej2-web-diagram-examples/tree/master/CollaborativeEditing)