---
layout: post
title: Port Positioning in JavaScript Diagram | Syncfusion®
description: Align ports to node boundaries in the Syncfusion® JavaScript Diagram using offset, margin, horizontalAlignment, and verticalAlignment settings.
...
# Port Positioning in JavaScript Diagram
...
The [`offset`](../../api/diagram/pointportmodel#offset) property is used to align the ports based on fractions. 0 represents top/left corner, 1 represents bottom/right corner, and 0.5 represents half of width/height.
