---
layout: post
title: Multiple Segments in JavaScript Diagram | Syncfusion®
description: Compose connectors with multiple straight, orthogonal, or bezier segments in the Syncfusion® JavaScript Diagram for complex routing paths.
...
# Multiple Segments in JavaScript Diagram
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/connectors-multipleSeg" %}

## Undo/Redo support for connector segments

The JavaScript Diagram control provides comprehensive undo and redo functionality for all connector segment operations. This includes reversible actions such as dragging, resizing, and rotating source or target nodes, as well as modifying segment points and endpoints.
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/connectors-segundo" %}