---
layout: post
title: How to Connect MySQL in JavaScript Diagram | Syncfusion®
description: Connect the Syncfusion® JavaScript Diagram to a MySQL database using LINQ2DB and an ASP.NET Core Web API to render an organizational chart.
...
# How to Connect MySQL in JavaScript Diagram
...
| npm | Latest | Package manager for JavaScript dependencies |
...
MySQL Server provides the relational database engine used to store organizational chart data required by the JavaScript Diagram component.
...
This section explains how to create an ASP.NET Core Web API project that connects to MySQL and exposes data for use by the Syncfusion® JavaScript Diagram component.
...
// IMPORTANT: This allows the JavaScript frontend (http://localhost:5173) to make requests to this backend (http://localhost:5296)
...
- `AddCors()`: Configures CORS to allow JavaScript frontend (different origin) to make requests.
...
## Integrating Syncfusion® JavaScript Diagram

The following steps describe how to render the Diagram and connect it to the MySQL Server back-end.

### Step 1: Creating the JavaScript client application

Create the JavaScript client application using the following commands in a Visual Studio Code terminal or command prompt:

```bash
npm create vite@latest diagram_mysql.client -- --template vanilla
```
```bash
cd diagram_mysql.client
```

This command scaffolds a new JavaScript application using Vite.
...
Add the required CSS references to the **src/style.css** file to apply styling to the JavaScript Diagram component.
...
For this project, the "Bootstrap 5.3" theme is applied. Other themes can be selected, or the existing theme can be customized to meet specific project requirements. For detailed guidance on theming and customization, refer to the [Syncfusion® JavaScript Components Appearance](https://ej2.syncfusion.com/javascript/documentation/appearance/theme-studio) documentation.

### Step 3: Add Syncfusion® JavaScript Diagram

Add the following markup to **index.html** to include the diagram container and load the stylesheet and script:
...
<html lang="en">
  <head>
    ...
    <title>diagram_mysql.client</title>
  </head>
  <body>
    <div id="diagram"></div>
...
Create a basic Diagram instance in **src/main.js**:
...
// Create a Diagram instance and append it to a DOM element
...
Add the data binding configuration to Diagram:
...
Call `Diagram.Inject` to enable data binding and automatic organizational chart layout:

```javascript
// ...existing code...
Diagram.Inject(DataBinding, HierarchicalTree);
// Ensure injection occurs before creating the Diagram instance
// ...existing code...
```

### Complete code

Here is the complete **src/main.js** file:
...
### Starting the JavaScript frontend
...
3. Check frontend configuration
   ...
   - Confirm the DataManager/service URL in **src/main.js** uses the correct HTTP port, e.g.: **http://localhost:5296/api/diagram/items**

### Application shows the diagram twice
  - Stop the JavaScript client application (press **Ctrl+C** in the terminal where it's running) and then restart it:
    ```bash
    npm run dev
    ```
...
A fully functional working sample of this project is available on [GitHub Repository](https://github.com/SyncfusionExamples/ej2-web-diagram-examples/tree/master/JavaScript/connecting-to-database/syncfusion-js-diagram-MySQL)
...
- [Syncfusion® JavaScript Diagram Getting Started](https://ej2.syncfusion.com/javascript/documentation/diagram/getting-started)
- [Data Binding Documentation](https://ej2.syncfusion.com/javascript/documentation/diagram/data-binding)
- [Organizational Chart Layout](https://ej2.syncfusion.com/javascript/documentation/diagram/automatic-layout/org-chart)
