---
layout: post
title: Localization in JavaScript Diagram | Syncfusion®
description: Localize the symbol palette search and context menu items in the Syncfusion® JavaScript Diagram by setting the locale property of the component.
...
# Localization in JavaScript Diagram

The EJ2 JavaScript Diagram component supports `localization`. In the JavaScript Diagram component, the symbol palette search box and context menu items can be localized based on the selected culture. By using the locale property of the diagram, you can change the culture.
