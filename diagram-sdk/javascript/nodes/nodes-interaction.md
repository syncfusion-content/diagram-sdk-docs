...
The JavaScript Diagram provides support to flip the node. [`flip`](../../api/diagram/node#flip) is performed to give the mirrored image of the original element.
