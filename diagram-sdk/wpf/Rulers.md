...
[How to round off the ruler's value if it displays a decimal value in the WPF Diagram ?](https://support.syncfusion.com/kb/article/18665/how-to-round-off-the-rulers-value-if-it-displays-a-decimal-value-in-the-wpf-diagram-sfdiagram)