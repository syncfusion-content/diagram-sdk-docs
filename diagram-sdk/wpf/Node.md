...
A node can be created and added to the [WPF Diagram](https://www.syncfusion.com/diagram-sdk/wpf-diagram), either programmatically or interactively. Nodes are stacked on the Diagram area from bottom to top in the order they are added.
