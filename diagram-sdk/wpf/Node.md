...
A node can be created and added to the [WPF SfDiagram](https://www.syncfusion.com/diagram-sdk/wpf-diagram), either programmatically or interactively. Nodes are stacked on the Diagram area from bottom to top in the order they are added.
...
[How to enable or disable the QuickCommands for node in WPF SfDiagram ?](https://support.syncfusion.com/kb/article/5902/how-to-enable-or-disable-quickcommands-in-wpf-diagram)
...
[How to disable Ctrl + Drag duplicate behavior in WPF SfDiagram ?](https://support.syncfusion.com/kb/article/18502/how-to-disable-ctrl--drag-duplicate-behavior-in-wpf-diagramsfdiagram)

[How to Fit Selected Nodes and Connectors to the WPF SfDiagram Window?](https://support.syncfusion.com/kb/article/18062/how-to-fit-selected-nodes-and-connectors-to-the-wpf-diagram-window)
...
[How to set the semi-transparent color to Nodes in the WPF SfDiagram ?](https://support.syncfusion.com/kb/article/17882/how-to-set-the-semi-transparent-color-to-nodes-in-the-wpf-diagram-sfdiagram)
...
[How to apply styles to nodes based on key values in the WPF SfDiagram?](https://support.syncfusion.com/kb/article/16203/how-to-apply-styles-to-nodes-based-on-key-values-in-the-wpf-diagram)

[How to Get the Node or Connector in the MouseMove Event in the WPF SfDiagram ?](https://support.syncfusion.com/kb/article/15646/how-to-get-the-node-or-connector-in-the-mousemove-event-in-the-wpf-diagram-sfdiagram)
...
[How to avoid the node clipping while export in the WPF SfDiagram?](https://support.syncfusion.com/kb/article/15536/how-to-avoid-the-node-clipping-while-export-in-the-wpf-diagram)

[How to manage the visibility of node and connector objects in the WPF SfDiagram ?](https://support.syncfusion.com/kb/article/14995/how-to-manage-the-visibility-of-node-and-connector-objects-in-the-wpf-diagram-sfdiagram)
...
[How to restrict annotation editing by double-clicking the node or connector in WPF SfDiagram ?](https://support.syncfusion.com/kb/article/8539/how-to-restrict-annotation-editing-by-double-clicking-the-node-or-connector-in-wpf-diagram)

[How to restrict Connector's source/target changing from native Nodes to other Nodes in WPF SfDiagram?](https://support.syncfusion.com/kb/article/11796/how-to-restrict-connectors-source-target-changing-from-native-nodes-to-other-nodes-in-wpf)

[How to create filled PolyLine Node in WPF SfDiagram ?](https://support.syncfusion.com/kb/article/10255/how-to-create-filled-polyline-node-in-wpf-diagram-sfdiagram)
