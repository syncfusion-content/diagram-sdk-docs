...
* **Limited**: Allows you to drag the diagram objects within the specified area. The [EditableArea](https://help.syncfusion.com/cr/wpf/Syncfusion.UI.Xaml.Diagram.ScrollSettings.html#Syncfusion_UI_Xaml_Diagram_ScrollSettings_EditableArea) property is used to specify the area where dragging is allowed.

The default value is `Infinity`. 

Drag limit behavior is enabled by handling the `SelectorChangedEvent` and its arguments of `SelectorChangedEventArgs` class of diagram control.
