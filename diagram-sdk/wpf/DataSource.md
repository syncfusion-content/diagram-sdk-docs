...
[WPF SfDiagram control](https://www.syncfusion.com/diagram-sdk/wpf-diagram) can be populated with the nodes and connectors based on the information provided from an external data source.
