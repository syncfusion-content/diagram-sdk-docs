...
[How to drag and drop elements from a TreeView in WPF Diagram?](https://support.syncfusion.com/kb/article/9277/how-to-drag-and-drop-elements-from-treeview-in-wpf-diagram-sfdiagram)
...
[How to group all the SymbolViewModels into the same group in WPF Diagram?](https://support.syncfusion.com/kb/article/18672/how-to-group-all-the-symbolviewmodels-into-the-same-group-in-the-wpf-diagram-sfdiagram)

[How to create a customized Stencil using SVG images in WPF Diagram?](https://support.syncfusion.com/kb/article/18251/how-to-create-customized-stencil-using-svg-images-in-wpf-sfdiagram)

[How to change the cursor to a block cursor when hovering in WPF Diagram?](https://support.syncfusion.com/kb/article/18242/how-to-change-cursor-to-block-cursor-when-hovering-in-wpf-sfdiagram)
...
[How to drag and drop both default and custom nodes from the Stencil into the WPF Diagram ?](https://support.syncfusion.com/kb/article/18459/how-to-drag-and-drop-both-default-and-custom-node-from-the-stencil-into-the-wpf-diagram-sfdiagram)
