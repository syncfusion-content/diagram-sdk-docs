...
Triggers when the node is clicked. The following code example explains how to get the [`click`](https://ej2.syncfusion.com/vue/documentation/api/diagram/index-default#click) event in the diagram.
...
The following code example explains how to get the [`selectionChange`](https://ej2.syncfusion.com/vue/documentation/api/diagram/index-default#selectionchange) event in the diagram.
...
The following code example explains how to get the [`positionChange`](https://ej2.syncfusion.com/vue/documentation/api/diagram/index-default#positionchange) event in the diagram.
...
The following code example explains how to get the [`sizeChange`](https://ej2.syncfusion.com/vue/documentation/api/diagram/index-default#sizechange) event in the diagram.
...
The following code example explains how to get the [`rotateChange`](https://ej2.syncfusion.com/vue/documentation/api/diagram/index-default#rotatechange) event in the diagram.
...
Triggers when there is any property change occurred for the node. The following code example explains how to get the [`propertyChange`](https://ej2.syncfusion.com/vue/documentation/api/diagram/index-default#propertychange) event in the diagram.
...
The following code example explains how to get the [`collectionChange`](https://ej2.syncfusion.com/vue/documentation/api/diagram/index-default#collectionchange) event in the diagram.
...
The [`mouseEnter`](https://ej2.syncfusion.com/vue/documentation/api/diagram/index-default#mouseenter) is triggered when the mouse enters the node surface.

### Mouse over event

The [`mouseOver`](https://ej2.syncfusion.com/vue/documentation/api/diagram/index-default#mouseover) is triggered when the mouse hover over the node surface.

### Mouse leave event

The [`mouseLeave`](https://ej2.syncfusion.com/vue/documentation/api/diagram/index-default#mouseleave) is triggered when the mouse leaves the node surface.
