...
The [`selectionChange`](https://ej2.syncfusion.com/vue/documentation/api/diagram/index-default#selectionchange) event is triggered when an annotation of a node or connector is selected in the diagram.
