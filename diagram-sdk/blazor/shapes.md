...
{% previewsample "https://blazorplayground.syncfusion.com/embed/BZVnZnBIJhwNCuqh?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Image Node in Blazor Diagram](images/blazor-diagram-image-node.webp)" %}
...
@* Initialize Diagram *@
<SfDiagramComponent Height="600px" Nodes="@_nodes"></SfDiagramComponent>
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/VZrRZdVIfBOynuGY?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Base64 Image Node in Blazor Diagram](images/blazor-diagram-base64-image-node.webp)" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/hNLdtxLSTUZWFHCt?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" %}
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/BZhHjRhyzKCqJItf?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[HTML Node Template in Blazor Diagram](images/blazor-diagram-html-node-template.webp)" %}
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/BjBHXHLITgBMxbvX?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[BasicShape Node in Blazor Diagram](images/blazor-diagram-basic-shape-node.webp)" %}
...
To create a path node, set the shape as **Path**. The geometry of the path is defined using the [Data](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Diagram.PathShape.html#Syncfusion_Blazor_Diagram_PathShape_Data) property. The following code illustrates how a path node is created.
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/hZrdNHLyzKqMcBHc?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Path Shape Node in Blazor Diagram](images/blazor-diagram-path-shape-node.webp)" %}

## How to Create a Flow Shape Node

The [FlowShape](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Diagram.FlowShape.html) represent process flow. It is used for analyzing, designing and managing the documentation process. To create a flow shape, specify the shape type as **Flow**. By default, it is considered as a **Process**. The following code example illustrates how to create a flow shape.
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/rNVnDxLypKzOqJIq?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[SVG Node in Blazor Diagram](images/blazor-diagram-svg-node.webp)" %}
    ...
    <DiagramTemplates>
        <NodeTemplate>
            @{
                ...
                if (node?.Shape is Shape shape &&
                    shape.Type == NodeShapes.HTML)
                {
                    <div style="width:100px;height:100px">
                        <SfButton Content="HTML Node"></SfButton>
                    </div>
                }
            }
        </NodeTemplate>
...
<div style="margin-top:20px;width:250px;">
    ...
    private string _selectedType = "Basic";
    ...
    private async Task OnShapeTypeChanged(ChangeEventArgs<string, string> args)
    {
        if (_node == null || string.IsNullOrEmpty(args.Value))
        {
            return;
        }
