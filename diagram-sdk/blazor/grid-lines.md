...
description: Checkout and learn here all the features about Grid Lines in Blazor Diagram component and much more details.
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/rjLHtHLkJlQpJqKU?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[GridLines in Blazor Diagram](images/blazor-diagram-gridlines.webp)" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/LtrHZnrOpvldOhWq?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" %}
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/LtrHDdhaJPEMRFMG?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Dot Grid in Blazor Diagram](images/blazor-diagram-dot-grid.webp)" %}
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/BtVnZxrapvulksFw?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Blazor Diagram with Custom Thickness of GridLines](images/blazor-diagram-custom-gridlines-thickness.webp)" %}
...
```
{% previewsample "https://blazorplayground.syncfusion.com/embed/rXLdXHrOJaJLZwMv?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" %}
...
{% previewsample "https://blazorplayground.syncfusion.com/embed/LtVdtRLEzEnQmmZs?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[GuideLines in Blazor Diagram](images/SnapLineStyle.webp)" %}