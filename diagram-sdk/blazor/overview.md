...
# About Syncfusion Blazor Diagram Component.
 ...
 ![Blazor Diagram Component Overview](images/Flowchart.webp)

## Key features of Blazor Diagram Component are as follows:
...
* **Undo/Redo:** Allows you to keep track of the recent changes made in a Blazor Diagram Component to correct your mistakes.
...
* **Ruler:** Added horizontal and vertical guides for precise measuring in the Blazor Diagram Component. The ruler ensures accuracy when placing, sizing, and aligning shapes and objects within a diagram.
...
* **CRUD:** The Blazor Diagram Component supports real-time CRUD actions, enabling dynamic manipulation of the DataSource. This allows seamless addition, modification, and removal of nodes, connectors, and other diagram elements during runtime, enhancing interactivity and data management capabilities.
