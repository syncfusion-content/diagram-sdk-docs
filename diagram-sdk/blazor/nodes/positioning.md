...
{% previewsample "https://blazorplayground.syncfusion.com/embed/hDLnXRBeTVsGLmKu?appbar=false&editor=false&result=true&errorlist=false&theme=fluent2" backgroundimage "[Changing a nodes rotation angle in Blazor Diagram](../images/blazor-diagram-node-rotation-angle.webp)" %}
