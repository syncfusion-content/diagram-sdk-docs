...
The [`width`](https://ej2.syncfusion.com/angular/documentation/api/diagram/symbolpreview#width) and [`height`](https://ej2.syncfusion.com/angular/documentation/api/diagram/symbolpreview#height) properties of SymbolPalette allow you to define the preview size for all symbol palette items. The [`offset`](https://ej2.syncfusion.com/angular/documentation/api/diagram/symbolpreview#offset) property specifies the position of the dragging helper relative to the mouse cursor.
