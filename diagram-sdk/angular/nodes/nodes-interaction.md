...
The Angular Diagram component supports node flipping operations to create mirrored images of nodes. The [`flip`](https://ej2.syncfusion.com/angular/documentation/api/diagram/node#flip) property controls the flip direction and behavior.
