...
Touch support in the [WinForms Diagram](https://www.syncfusion.com/winforms-ui-controls/diagram) control lets users interact with diagram nodes through touch gestures. Users can select nodes, edit label text, open the context menu, and zoom in or out using tap, double tap, long press, pinch, and other gestures.
