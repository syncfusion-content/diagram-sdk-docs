...
To enable rulers, set the **ShowRulers** property to true on the [WinForms Diagram](https://www.syncfusion.com/winforms-ui-controls/diagram) control. The rulers automatically inherit the **MeasurementUnit** configured on the diagram model and display their ticks in that unit.
