...
The central port for a [WinForms Diagram](https://www.syncfusion.com/winforms-ui-controls/diagram) node can be enabled or disabled by using the EnableCentralPort property. By default, the central port is enabled. 
