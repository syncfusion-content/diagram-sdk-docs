...
The [WinForms Diagram](https://www.syncfusion.com/winforms-ui-controls/diagram) control supports many node types. The following node types are available in the WinForms Diagram control:
