...
Layers are transparent sheets that can be added to the model to organize diagram objects. Layers help arrange a set of nodes on the [WinForms Diagram](https://www.syncfusion.com/winforms-ui-controls/diagram).
