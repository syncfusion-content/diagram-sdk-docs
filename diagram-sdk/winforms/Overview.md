...
* WinForms Diagram supports Matrix Transformations likeTranslate (Move), Rotate and Scale.
...
* WinForms Diagram supports rendering TextNodes and RichTextNodes, and offers full text formatting through sufficient properties. Text editing and text rotation are also supported.
