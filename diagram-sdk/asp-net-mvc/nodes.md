---
layout: post
title: Nodes in ASP.NET MVC Diagram | Syncfusion®
description: Create, position, and style nodes in Syncfusion® ASP.NET MVC Diagram to visually represent data, processes, and entities, with runtime add/remove.
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/run/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Run.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/run/run.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/nodescollection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Nodescollection.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/nodescollection/nodescollection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/position/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Position.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/position/position.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/flip/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Flip.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/flip/flip.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/appear/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Appear.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/appear/appear.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/linearGrad/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="LinearGrad.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/linearGrad/linearGrad.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/radialGrad/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="RadialGrad.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/radialGrad/radialGrad.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/shadow/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Shadow.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/shadow/shadow.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/shadow2/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Shadow2.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/shadow2/shadow2.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/icon/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Icon.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/icon/icon.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/dataflow/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Dataflow.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/node/dataflow/dataflow.cs %}
{% endhighlight %}
{% endtabs %}
