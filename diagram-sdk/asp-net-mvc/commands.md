...
Alignment commands enables to align the selected or defined objects such as nodes and connectors with respect to the selection boundary. Refer to [`align`](https://ej2.syncfusion.com/documentation/api/diagram/index-default#align) commands which shows how to use align methods in the diagram.
