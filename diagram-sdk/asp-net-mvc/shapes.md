...
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/text/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Text.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/text/text.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/image/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Image.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/image/image.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/imagebase64/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Imagebase64.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/imagebase64/imagebase64.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/scale/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Scale.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/scale/scale.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/HTML/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="HTML.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/HTML/HTML.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/HTML-FnContent/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="HTML.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/HTML-FnContent/HTML.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/HTML-Template/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="HTML.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/HTML-Template/HTML.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/HTML-TemplateFnNode/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="HTML.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/HTML-TemplateFnNode/HTML.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/native/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Native.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/native/native.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/native-FnContent/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Native.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/native-FnContent/native.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/native-Template/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Native.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/native-Template/SVG.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/Native-TemplateFnNode/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Native.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/Native-TemplateFnNode/HTML.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/basic/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Basic.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/basic/basic.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/path/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Path.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/path/path.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/flow/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Flow.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/shapes/flow/flow.cs %}
{% endhighlight %}
{% endtabs %}
