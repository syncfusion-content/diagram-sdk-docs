...
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationRender/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationRender/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationRender/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationRender/annotation.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/updateAnnotation/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/updateAnnotation/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/updateAnnotation/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/updateAnnotation/annotation.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationOffset/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationOffset/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationOffset/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationOffset/annotation.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/HVAlignAnnotation/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/HVAlignAnnotation/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/HVAlignAnnotation/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/HVAlignAnnotation/annotation.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationSegment/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationSegment/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationSegment/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationSegment/annotation.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationMargin/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationMargin/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationMargin/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationMargin/annotation.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationTextAlign/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationTextAlign/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationTextAlign/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/annotationTextAlign/annotation.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/hyperLink/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="HyperLink.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/hyperLink/hyperLink.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/hyperLink/razor %}
{% endhighlight %}
{% highlight c# tabtitle="HyperLink.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/hyperLink/hyperLink.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/labelTemplate/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="LabelTemplate.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/labelTemplate/labelTemplate.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/labelTemplate/razor %}
{% endhighlight %}
{% highlight c# tabtitle="LabelTemplate.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/labelTemplate/labelTemplate.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/textWrapping/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/textWrapping/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/textWrapping/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/textWrapping/annotation.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/textOverFlow/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/textOverFlow/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/textOverFlow/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/textOverFlow/annotation.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/appearance/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/appearance/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/appearance/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/appearance/annotation.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/appearanceStyle/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/appearanceStyle/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/appearanceStyle/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/appearanceStyle/annotation.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/readOnly/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/readOnly/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/readOnly/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/readOnly/annotation.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/dragLimit/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="DragLimit.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/dragLimit/dragLimit.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/dragLimit/razor %}
{% endhighlight %}
{% highlight c# tabtitle="DragLimit.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/dragLimit/dragLimit.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/multiAnnotation/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/multiAnnotation/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/multiAnnotation/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/annotation/multiAnnotation/annotation.cs %}
{% endhighlight %}
