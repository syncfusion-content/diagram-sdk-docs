---
layout: post
title: Layers in ASP.NET MVC Diagram | Syncfusion®
description: Organize Syncfusion® ASP.NET MVC Diagram shapes into named layers to show, hide, lock, or group objects selectively across the canvas.
...
# Layers in ASP.NET MVC Diagram

**Layer** is used to organize related shapes on a ASP.NET MVC Diagram control. A layer is a named category of shapes. By assigning shapes to different layers, you can selectively view, remove, and lock different categories of shapes.
...
// initialize ASP.NET MVC Diagram component
