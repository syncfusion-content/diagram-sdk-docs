...
{% include code-snippet/diagram-sdk/asp-net-mvc/interaction/panstatus/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Panstatus.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/interaction/panstatus/panstatus.cs %}
{% endhighlight %}
{% endtabs %}
