---
layout: post
title: Drag, Resize, and Rotate in ASP.NET MVC Diagram | Syncfusion®
description: Drag, resize, and rotate Syncfusion® ASP.NET MVC Diagram objects with custom handles, snapping, and optional negative-axis interaction restriction.
...
# Drag, Resize, and Rotate in ASP.NET MVC Diagram
...
The ASP.NET MVC Diagram component includes a built-in option to restrict user interactions within the negative axis region—areas defined by negative X or Y coordinates. By enabling the `RestrictNegativeAxisDragDrop` constraint, the following interactions are prevented:
