...
# BPMN Shapes in ASP.NET MVC Diagram
...
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/End/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="End.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/End/end.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/trigger/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Trigger.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/trigger/trigger.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/gateWay/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="GateWay.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/gateWay/gateWay.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/Activity/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Activity.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/Activity/Activity.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/task/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Task.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/task/task.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/subProcess/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="SubProcess.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/subProcess/subProcess.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/subEvent/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="SubEvent.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/subEvent/subEvent.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/Transaction/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Transaction.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/Transaction/Transaction.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/loop/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Loop.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/loop/loop.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/compensation/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Compensation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/compensation/compensation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/call/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Call.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/call/call.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/adhoc/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Adhoc.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/adhoc/adhoc.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/boundary/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Boundary.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/boundary/boundary.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/dataObject/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="DataObject.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/dataObject/dataObject.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/Datasource/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Datasource.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/Datasource/Datasource.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/textAnnotation/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="TextAnnotation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/textAnnotation/textAnnotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/group/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Group.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/group/group.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/association/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Association.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/association/association.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/Sequence/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Sequence.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/Sequence/Sequence.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/Message/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Message.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/bpmn/Message/Message.cs %}
{% endhighlight %}
{% endtabs %}
