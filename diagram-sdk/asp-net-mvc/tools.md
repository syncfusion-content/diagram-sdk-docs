...
{% include code-snippet/diagram-sdk/asp-net-mvc/Tools/shapes/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Shapes.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/Tools/shapes/shapes.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/Tools/node/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Node.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/Tools/node/node.cs %}
{% endhighlight %}
{% endtabs %}
