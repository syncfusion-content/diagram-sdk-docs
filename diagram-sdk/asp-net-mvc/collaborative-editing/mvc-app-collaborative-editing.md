...
# SignalR Hub Configuration in ASP.NET Core Diagram
...
{% include code-snippet/diagram-sdk/asp-net-mvc/collaborative-editing/config/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/collaborative-editing/config/razor %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/collaborative-editing/realtimeChanges/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/collaborative-editing/realtimeChanges/razor %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/collaborative-editing/conflict/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/collaborative-editing/conflict/razor %}
{% endhighlight %}
{% endtabs %}
{% endif %}
