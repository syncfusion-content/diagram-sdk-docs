---
layout: post
title: Umldiagram in ASP.NET MVC Diagram Control | Syncfusion
...
# UML Diagram Shapes in ASP.NET MVC Diagram Control
...
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/class/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Class.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/class/class.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/class/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Class.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/class/class.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/interface/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Interface.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/interface/interface.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/interface/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Interface.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/interface/interface.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/enumeration/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Enumeration.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/enumeration/enumeration.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/enumeration/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Enumeration.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/enumeration/enumeration.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/association/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Association.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/association/association.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/association/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Association.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/association/association.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/aggregation/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Aggregation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/aggregation/aggregation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/aggregation/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Aggregation.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/aggregation/aggregation.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/composition/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Composition.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/composition/composition.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/composition/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Composition.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/composition/composition.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/dependency/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Dependency.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/dependency/dependency.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/dependency/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Dependency.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/dependency/dependency.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/inheritance/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Inheritance.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/inheritance/inheritance.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/inheritance/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Inheritance.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/inheritance/inheritance.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/multiplicity/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Multiplicity.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/multiplicity/multiplicity.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/multiplicity/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Multiplicity.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/multiplicity/multiplicity.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/uml/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Umlclass.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/uml/umlclass.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/uml/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Umlclass.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/uml/umlclass.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/UmlActivity/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="UmlActivity.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/UmlActivity/UmlActivity.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/UmlActivity/razor %}
{% endhighlight %}
{% highlight c# tabtitle="UmlActivity.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/UmlActivity/UmlActivity.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/UmlActivityConnector/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="UmlActivityConnector.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/UmlActivityConnector/UmlActivityConnector.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/UmlActivityConnector/razor %}
{% endhighlight %}
{% highlight c# tabtitle="UmlActivityConnector.cs" %}
{% include code-snippet/diagram-sdk/asp-net-mvc/umldiagramshapes/UmlActivityConnector/UmlActivityConnector.cs %}
{% endhighlight %}
