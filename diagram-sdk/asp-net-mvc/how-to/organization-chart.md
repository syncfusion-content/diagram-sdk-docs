...
description: Build an organization chart in Syncfusion® ASP.NET MVC Diagram using HTML templates for each employee node and the OrganizationalChart layout.
...
# How to use HTML template in organization chart in ASP.NET MVC Diagram
