...
| Region | Description |
|-------- | -------- |
| PageSettings | Exports based on the diagram [`PageSettings`](https://ej2.syncfusion.com/react/documentation/api/diagram/index-default#pagesettings). |
| Content | Exports only the diagram bounds, excluding empty space. | 
