...
description: Model software in React with UML class and activity diagrams featuring attributes, methods, lifelines, decisions, and object-oriented design.
control: Umldiagram 
...
N> Before working with UML diagrams, ensure you have set up the React Diagram component by following the [getting started](./getting-started) guide.
