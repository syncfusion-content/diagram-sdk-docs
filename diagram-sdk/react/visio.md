...
## Why use Visio with the React Diagram?

Many organizations maintain existing diagrams created using Microsoft Visio. Recreating these diagrams in a web application can require significant effort. The React Diagram component provides Visio integration to support the following scenarios:

- Reuse existing Visio diagrams in web applications.  
- Visualize and edit Visio diagrams using the React Diagram component.  
...
## Export React Diagram to Visio

### How Visio export works

The React Diagram component supports exporting diagrams to Microsoft Visio format using the [`exportToVisio`](https://ej2.syncfusion.com/react/documentation/api/diagram/index-default#exporttovisio) method. This method generates a **.vsdx** file and automatically downloads it through the browser.
