...
By default, if no segments are explicitly defined for a Bezier connector, the React Diagram component automatically generates segments. This routing logic is designed to prevent the connector from overlapping with its connected source and target nodes, ensuring a clean and readable layout.
