...
To create a bezier segment, the [`segment.type`](https://ej2.syncfusion.com/react/documentation/api/diagram/segments) is set as **bezier** and you need to specify the connector `type` as `Bezier` using [`type`](https://helpej2.syncfusion.com/react/documentation/api/diagram/connector#type). 
...
![Bezier Control point set by vector1 and vector2](images/Bezier-vector1.gif)
...
To customize the thumb size for a specific connector, disable the [`InheritSegmentThumbSize`](https://helpej2.syncfusion.com/react/documentation/api/diagram/connectorConstraints) constraint, then set the desired `segmentThumbSize` on that connector.
