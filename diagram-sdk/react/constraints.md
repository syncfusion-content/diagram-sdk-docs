...
> By default, the following constraints are enabled in the diagram. The `Default` constraint is a composite flag that includes these individual constraints:
> - Zoom
> - ApiUpdate
> - PanX
> - PanY
...
| ReadOnly | Enables read-only mode for the node. |
