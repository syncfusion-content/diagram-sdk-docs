...
You can remove palettes from the symbol palette at runtime. Use the [`removePalettes`](https://ej2.syncfusion.com/react/documentation/api/symbol-palette#removepalettes) method to remove multiple palettes by passing an array of palette `id`s as a parameter.
