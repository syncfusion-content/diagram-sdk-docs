...
- `AddCors()`: Configures CORS to allow React frontend (different origin) to make requests.
...
A fully functional working sample of this project is available on [GitHub Repository](https://github.com/SyncfusionExamples/ej2-web-diagram-examples/tree/master/React/connecting-to-database/syncfusion-react-diagram-MySQL)
