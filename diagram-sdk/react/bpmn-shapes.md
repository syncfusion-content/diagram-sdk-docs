...
> **Important**: To use BPMN shapes in the diagram, inject the BpmnDiagrams module into the React Diagram component. This module provides the necessary functionality for rendering and managing BPMN-specific features.
