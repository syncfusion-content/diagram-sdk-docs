...
# Installing Syncfusion Diagram SDK web installer


## Overview

For the Essential Studio Diagram SDK product, Syncfusion offers a Web Installer. This installer alleviates the burden of downloading a larger installer. You can simply download and run the online installer, which will be smaller in size and will download and install the Essential Studio products you have chosen. You can get the most recent version of Essential Studio Web Installer [here](https://www.syncfusion.com/downloads/latest-version). 

 
## Installation

The steps below show how to install Essential Studio Diagram SDK Web Installer.

1.  Open the Syncfusion Essential Studio Diagram SDK Web Installer file from downloaded location by double-clicking it. The Installer Wizard automatically opens and extracts the package.

    ![Installer Extraction Wizard](images/Step-by-Step-Installation_img1.png)

    
    N> The installer wizard extracts the syncfusionessentialDiagramSDKwebinstaller_{version}.exe dialog, which displays the package's unzip operation.
    
2. 	The Syncfusion Diagram SDK Web Installer's welcome wizard will be displayed. Click the Next button.
...
Syncfusion Diagram SDK installer can be uninstalled in two ways.

   * Uninstall the Diagram SDK using the Syncfusion Diagram SDK web installer
   * Uninstall the Diagram SDK from Windows Control Panel

Follow either one of the option below to uninstall Syncfusion Essential Studio Diagram SDK installer.
  
**Option 1: Uninstall the Diagram SDK using the Syncfusion Diagram SDK web installer**
...
**Option 2: Uninstall the Diagram SDK from Windows Control Panel**  
	
You can uninstall all the installed products by selecting the **Syncfusion Essential Studio {version}** entry (element 1 in the below screenshot) from the Windows control panel, or you can uninstall Diagram SDK alone by selecting the **Syncfusion Essential Studio for Diagram SDK {version}** entry (element 2 in the below screenshot) from the Windows control panel.

![Control Panel](images/Step-by-Step-Installation_img22.png)
	
N> If the **Syncfusion Essential Studio for Diagram SDK {version}** entry is selected from the Windows control panel, the Syncfusion Essential Studio Diagram SDK alone will be removed and the below default MSI uninstallation window will be displayed.	

1.  The Syncfusion Diagram SDK Web Installer's welcome wizard will be displayed. Click the Next button
