---
layout: post
title: Downloading Syncfusion Diagram SDK Web Installer
description: Learn how to download the Syncfusion Diagram SDK web installer from the Syncfusion website using your license.
...
# Downloading Syncfusion Diagram SDK Web Installer
...
6. Click the Download (element 1 in the screenshot below) button to get the Syncfusion Essential Studio Diagram SDK web installer.
...
8. Before the license expires, you can download the installer at any time from your registered account’s [License & Downloads](https://www.syncfusion.com/account/downloads) page (See the screenshot below.)
   
   ![License and downloads of Syncfusion Essential Studio](images/start-trial-download-web-installer.png)
   
9. After downloading, the Syncfusion Diagram SDK web installer can be unlocked using Syncfusion registered login credential.
...
You can also refer to the [**Web installer**](https://help.syncfusion.com/diagram-sdk/installation/web-installer/how-to-install) links for step-by-step installation guidelines.	