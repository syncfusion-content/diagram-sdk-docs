...
[`Format`](https://ej2.syncfusion.com/documentation/api/diagram/iexportoptions#format) is to specify the type or format of the exported file. By default, the diagram is exported as .jpg format. You can export diagram to the following formats:
...
Diagram provides support to export any specific region of the diagram by using [`bounds`](https://ej2.syncfusion.com/documentation/api/diagram/iexportoptions#bounds).
