...
{% include code-snippet/diagram-sdk/asp-net-core/group/group/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Group.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/group/group/group.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/group/ungroup/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Ungroup.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/group/ungroup/ungroup.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/group/run/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Run.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/group/run/run.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/group/groupCollection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="GroupCollection.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/group/groupCollection/groupCollection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/group/stack/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Stack.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/group/stack/stack.cs %}
{% endhighlight %}
{% endtabs %}
