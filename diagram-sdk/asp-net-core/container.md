...
# Container in ASP.NET Core Diagram Component
...
{% include code-snippet/diagram-sdk/asp-net-core/container/basiccontainer/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Container.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/container/basiccontainer/Container.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/diagram-sdk/asp-net-core/container/basiccontainer/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Container.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/container/basiccontainer/Container.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/container/containerheader/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Container.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/container/containerheader/Container.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/container/containerheader/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Container.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/container/containerheader/Container.cs %}
{% endhighlight %}
