---
layout: post
title: Ports in ASP.NET Core Diagram | Syncfusion®
description: Define connection ports on Syncfusion® ASP.NET Core Diagram nodes at fraction offsets so connectors dock only to specific points.
...
{% include code-snippet/diagram-sdk/asp-net-core/ports/port/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Port.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/ports/port/port.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/ports/run/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Run.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/ports/run/run.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/ports/remove/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Remove.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/ports/remove/remove.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/ports/appear/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Appear.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/ports/appear/appear.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/ports/automaticPort/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Container.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/ports/automaticPort/AutoPort.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/diagram-sdk/asp-net-core/ports/automaticPort/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Container.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/ports/automaticPort/AutoPort.cs %}
{% endhighlight %}
