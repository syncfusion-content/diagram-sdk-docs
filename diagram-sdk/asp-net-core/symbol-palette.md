---
layout: post
title: Symbol Palette in Syncfusion® ASP.NET Core Diagram Component
...
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/palette/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Palette.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/palette/palette.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/symbols/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Symbols.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/symbols/symbols.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/contentTemplate/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="palette.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/contentTemplate/palette.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/restrict/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Restrict.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/restrict/restrict.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/fit/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Fit.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/fit/fit.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/margin/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Margin.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/margin/margin.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/preview/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Preview.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/preview/preview.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/default/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Default.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/default/default.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/default/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Default.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/default/default.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/description/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Description.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/description/description.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/symboltooltip/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Description.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/symboltooltip/description.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/defaulttooltip/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Description.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/symbol-palette/defaulttooltip/description.cs %}
{% endhighlight %}
{% endtabs %}
