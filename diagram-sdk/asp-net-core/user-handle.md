...
# User Handle in ASP.NET Core Diagram
...
ASP.NET Core Diagram allows to set size for the fixed user handles by using the `width` and `height` property. The default value of the width and height property is 10.
