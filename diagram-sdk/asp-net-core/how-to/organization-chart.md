...
# How to use HTML template in organization chart in ASP.NET Core Diagram
...
{% include code-snippet/diagram-sdk/asp-net-core/layout/customizedOrganizational/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="CustomizedOrganization.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/layout/customizedOrganizational/customizedOrganization.cs %}
{% endhighlight %}
{% endtabs %}
