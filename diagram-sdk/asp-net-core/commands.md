...
{% include code-snippet/diagram-sdk/asp-net-core/commands/align/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Align.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/align/align.cs %}
{% endhighlight %}
{% endtabs %}
...
The [`Distribute`](https://ej2.syncfusion.com/documentation/api/diagram/index-default#distribute) commands enable to place the selected objects on the page at equal intervals from each other. The selected objects are equally spaced within the selection boundary.
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/distribute/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Distribute.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/distribute/distribute.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/size/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Size.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/size/size.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/paste/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Paste.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/paste/paste.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/group/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Group.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/group/group.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/order/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Order.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/order/order.cs %}
{% endhighlight %}
{% endtabs %}
...
The [`margin`](https://ej2.syncfusion.com/documentation/api/diagram/ifitoptions#margin) parameter defines the region/bounds of the diagram content that is to be fit into the view.
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/existingCommand/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="ExistingCommand.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/existingCommand/existingCommand.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/nudge/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Nudge.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/nudge/nudge.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/diagram-sdk/asp-net-core/commands/nudge/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Nudge.cs" %}
{% include code-snippet/diagram-sdk/asp-net-core/commands/nudge/nudge.cs %}
{% endhighlight %}
