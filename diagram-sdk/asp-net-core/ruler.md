...
The Ruler provides a horizontal and vertical guide for measuring in the ASP.NET Core Diagram control. The Ruler can be used to measure the diagram objects, indicate positions, and align diagram elements. This is especially useful in creating scale models.
...
{% include code-snippet/diagram-sdk/asp-net-core/ruler/ruler/ruler.cshtml %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/diagram-sdk/asp-net-core/ruler/customRuler/customRuler.cshtml %}
{% endhighlight %}
{% endtabs %}
